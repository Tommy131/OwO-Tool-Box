...
class _ShutdownTabState extends State<ShutdownTab> {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              LocalizationKeys.shutdownScheduled.tr(context),
            ...
            Row(
              ...
              children: [
                _buildTimeUnit(
                  theme,
                  hours,
                  LocalizationKeys.hours.tr(context),
                ),
                ...
                _buildTimeUnit(
                  theme,
                  minutes,
                  LocalizationKeys.minute.tr(context),
                ),
                const SizedBox(width: 8),
                Text(':', style: theme.textTheme.headlineLarge),
                const SizedBox(width: 8),
                _buildTimeUnit(
                  theme,
                  seconds,
                  LocalizationKeys.second.tr(context),
                ),
              ],
            ),
            ...
            ElevatedButton.icon(
              ...
              label: Text(LocalizationKeys.cancelShutdown.tr(context)),
          ...
          children: [
            Expanded(
              child: RadioListTile<bool>(
                ...
                title: Text(LocalizationKeys.duration.tr(context)),
                subtitle: Text(LocalizationKeys.setDelayTime.tr(context)),
              ),
            ),
            Expanded(
              child: RadioListTile<bool>(
                ...
                title: Text(LocalizationKeys.specificTime.tr(context)),
                subtitle: Text(LocalizationKeys.setExactTime.tr(context)),
              ),
            ),
          ],
        ),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              LocalizationKeys.setDuration.tr(context),
              ...
              children: [
                Expanded(
                  child: _buildNumberInput(
                    ...
                    label: LocalizationKeys.hours.tr(context),
                ...
                Expanded(
                  child: _buildNumberInput(
                    ...
                    label: LocalizationKeys.minute.tr(context),
                    icon: Icons.timer,
                    max: 59,
                  ),
                ),
                ...
                Expanded(
                  child: _buildNumberInput(
                    ...
                    label: LocalizationKeys.second.tr(context),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              LocalizationKeys.setSpecificTime.tr(context),
              style: theme.textTheme.titleMedium?.copyWith(
                fontWeight: FontWeight.bold,
              ),
            ),
            ...
            ListTile(
              ...
              title: Text(
                _selectedTime != null
                    ...
                    : LocalizationKeys.selectDateTime.tr(context),
              ),
    ...
    return ElevatedButton.icon(
      ...
      label: Text(
        provider.isSchedulingShutdown
            ? LocalizationKeys.scheduling.tr(context)
            : LocalizationKeys.scheduleShutdown.tr(context),
      ),
      style: ElevatedButton.styleFrom(
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              LocalizationKeys.quickActions.tr(context),
              style: theme.textTheme.titleMedium?.copyWith(
                fontWeight: FontWeight.bold,
              ),
            ),
            ...
            Wrap(
              ...
              children: [
                _buildQuickActionChip(
                  theme,
                  label: LocalizationKeys.tenMinutes.tr(context),
                  icon: Icons.schedule,
                  onPressed: () => _quickSchedule(provider, 600),
                ),
                _buildQuickActionChip(
                  theme,
                  label: LocalizationKeys.thirtyMinutes.tr(context),
                  icon: Icons.schedule,
                  onPressed: () => _quickSchedule(provider, 1800),
                ),
                _buildQuickActionChip(
                  theme,
                  label: LocalizationKeys.oneHour.tr(context),
                  icon: Icons.schedule,
                  onPressed: () => _quickSchedule(provider, 3600),
                ),
                _buildQuickActionChip(
                  theme,
                  label: LocalizationKeys.twoHours.tr(context),
                  icon: Icons.schedule,
  ...
  Future<void> _scheduleShutdown(SystemToolsProvider provider) async {
    ...
    if (_useSpecificTime) {
      if (_selectedTime == null) {
        _showError(LocalizationKeys.pleaseSelectDateTime.tr(context));
        return;
      }
      ...
      if (totalSeconds <= 0) {
        _showError(LocalizationKeys.pleaseSetValidDuration.tr(context));
        return;
      }
    ...
    if (success && mounted) {
      _showSuccess(LocalizationKeys.shutdownScheduledSuccess.tr(context));
      // 清空输入
  ...
  Future<void> _cancelShutdown(SystemToolsProvider provider) async {
    final confirm = await showAdvancedConfirmDialog(
      context: context,
      title: LocalizationKeys.confirmCancelShutdown.tr(context),
      content: LocalizationKeys.confirmCancelShutdownMessage.tr(context),
      icon: Icons.warning_amber_rounded,
      confirmText: LocalizationKeys.cancelShutdown.tr(context),
      cancelText: LocalizationKeys.keepSchedule.tr(context),
    );

    if (confirm == true) {
      final success = await provider.cancelShutdown();
      if (success && mounted) {
        _showSuccess(LocalizationKeys.shutdownCancelled.tr(context));
      }
    }
  }
