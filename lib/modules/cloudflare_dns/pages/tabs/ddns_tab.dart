          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    LocalizationKeys.ddnsSettings.tr(context),
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(LocalizationKeys.syncNow.tr(context)),
                  ),
                ],
              ),
              ...
              Expanded(
                child: provider.ddnsConfigs.isEmpty
                    ? Center(
                        child: Text(LocalizationKeys.ddnsInactive.tr(context)),
                      )
                    : ListView.builder(
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  Text(
                                    '${LocalizationKeys.lastUpdated.tr(context)}: ${config.lastSync?.toString().split('.')[0] ?? 'Never'}',
                                  ),
  ...
  Widget _buildIPCard(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            LocalizationKeys.publicIP.tr(context),
