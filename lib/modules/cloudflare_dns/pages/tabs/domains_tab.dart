...
class _CloudflareDomainsTabState extends State<CloudflareDomainsTab> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!provider.isConfigured) {
      return Center(child: Text(LocalizationKeys.tokenInvalid.tr(context)));
    }
          ...
          children: [
            ...
            Expanded(
              child: _selectedZone == null
                  ? Center(
                      child: Text(
                        LocalizationKeys.selectDomainToManage.tr(context),
                      ),
                    )
  ...
  Widget _buildZonesList(CloudflareProvider provider, ColorScheme colorScheme) {
    ...
    if (provider.zones.isEmpty) {
      return Center(child: Text(LocalizationKeys.noDomainsFound.tr(context)));
    }
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                '${LocalizationKeys.dnsRecords.tr(context)} ($count)',
