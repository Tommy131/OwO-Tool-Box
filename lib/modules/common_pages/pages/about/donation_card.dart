    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              _tr(context, common_l10n.LocalizationKeys.cannotOpenUrl),
            ),
            backgroundColor: Colors.red,
            action: SnackBarAction(
              label: _tr(context, core_l10n.LocalizationKeys.confirm),
          ...
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        _tr(
                          context,
                          common_l10n.LocalizationKeys.supportDevelopment,
                        ),
                      ...
                      Text(
                        _tr(
                          context,
                          common_l10n.LocalizationKeys.donationDescription,
                        ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  _tr(context, common_l10n.LocalizationKeys.donateNow),
                ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        _tr(context, common_l10n.LocalizationKeys.topDonors),
                          ...
                          children: [
                            ...
                            Text(
                              _isFromApi
                                  ? _tr(
                                      context,
                                      common_l10n.LocalizationKeys.dataFromApi,
                                    )
                                  : _tr(
                                      context,
                                      common_l10n.LocalizationKeys.dataFromMock,
                                    ),
                              style: TextStyle(
                                fontSize: 11,
                                color: _isFromApi
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        _tr(context, common_l10n.LocalizationKeys.noDonorsYet),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          '${_statusMessage!}，${_tr(context, common_l10n.LocalizationKeys.showingMockData)}',
                          style: TextStyle(
                            fontSize: 12,
