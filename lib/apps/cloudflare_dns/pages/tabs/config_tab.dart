...
class _CloudflareConfigTabState extends State<CloudflareConfigTab> {
  ...
  Future<void> _verifyAndSave() async {
    ...
    if (mounted) {
      if (isValid) {
        ...
        CustomSnackBar(
          context,
          message: _tr(L18nKeys.tokenVerified),
        ...
        CustomSnackBar(
          context,
          message: _tr(L18nKeys.tokenInvalid),
          ...
          child: Form(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    _tr(L18nKeys.cloudflareApiSettings),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(_tr(L18nKeys.verifyToken)),
  ...
  Widget _buildStatusCard(
    ...
    if (isValid == true) {
      ...
      statusText = _tr(L18nKeys.tokenValid);
      subText = expiresAt != null
          ? '${_tr(L18nKeys.tokenExpiry)}: ${expiresAt.toString().split(' ')[0]}'
          : _tr(L18nKeys.tokenPermanent);
    } else if (isValid == false) {
      statusColor = theme.colorScheme.error;
      statusIcon = Icons.error;
      statusText = _tr(L18nKeys.tokenInvalid);
      subText = _tr(L18nKeys.apiTokenHint);
    }
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: _tr(L18nKeys.apiTokenHint),
        ...
        validator: (v) =>
            v == null || v.isEmpty ? _tr(L18nKeys.apiTokenHint) : null,
      ),
    );
  }
}
