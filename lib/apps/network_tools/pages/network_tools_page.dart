...
class _NetworkToolsPageState extends State<NetworkToolsPage>
                  ...
                  child: ListView(
                    children: [
                      _buildNavItem(
                        0,
                        Icons.speed_rounded,
                        _tr(L18nKeys.networkPing),
                      ),
                      _buildNavItem(
                        1,
                        Icons.bolt_rounded,
                        _tr(L18nKeys.networkPerformanceTest),
                      ),
                      _buildNavItem(
                        2,
                        Icons.security_rounded,
                        _tr(L18nKeys.networkSiteTest),
                      ),
                      _buildNavItem(
                        3,
                        Icons.lan_rounded,
                        _tr(L18nKeys.networkPortScan),
                      ),
                    ],
                  ),
                ),
  ...
  Widget _buildPingTool() {
    ...
    return _buildToolLayout(
      title: _tr(L18nKeys.networkPing),
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              labelText: _tr(L18nKeys.targetHost),
              isDense: true,
            ),
          ),
      ...
      actions: [
        ElevatedButton.icon(
          ...
          label: Text(
            provider.isPingRunning
                ? _tr(L18nKeys.stopTest)
                : _tr(L18nKeys.startTest),
          ),
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              DropdownButton<String>(
                ...
                items: [
                  DropdownMenuItem(
                    value: 'Client',
                    child: Text(_tr(L18nKeys.modeClient)),
                  ),
                  DropdownMenuItem(
                    value: 'Server',
                    child: Text(_tr(L18nKeys.modeServer)),
                  ),
                ].toList(),
                onChanged: (v) {
              ...
              _buildActionButton(
                ...
                label: provider.isPerfRunning
                    ...
                    : (provider.testMode == 'Server'
                          ? _tr(L18nKeys.startMonitor)
                          : _tr(L18nKeys.startSend)),
          ...
          GridView.count(
            ...
            children: [
              _buildChartCard(
                _tr(L18nKeys.socketSend),
                provider.socketSendHistory,
                Colors.blue,
                ' Pkt/s',
              ),
              _buildChartCard(
                _tr(L18nKeys.socketReceive),
                provider.socketReceiveHistory,
                Colors.green,
                ' Pkt/s',
              ),
              _buildChartCard(
                _tr(L18nKeys.sendSpeed),
                provider.sendBytesHistory,
                Colors.orange,
                ' MB/s',
              ),
              _buildChartCard(
                _tr(L18nKeys.receiveSpeed),
        ...
        children: [
          ...
          if (provider.testMode == 'Client') ...[
            _buildNumericStepper(
              ...
              _tr(L18nKeys.connections),
              10,
            ),
            _buildNumericStepper(
              provider.perfIntervalController,
              _tr(L18nKeys.intervalMs),
              10,
            ),
            _buildNumericStepper(
              provider.perfDataSizeController,
              _tr(L18nKeys.dataSize),
              10,
            ),
          ],
        ],
  ...
  Widget _buildSiteTool() {
    final provider = context.watch<NetworkToolsProvider>();
    return _buildToolLayout(
      title: _tr(L18nKeys.networkSiteTest),
      ...
      actions: [
        ElevatedButton.icon(
          ...
          label: Text(_tr(L18nKeys.startTest)),
        ),
        const Spacer(),
        IconButton(
  ...
  Widget _buildPortScanTool() {
    final provider = context.watch<NetworkToolsProvider>();
    return _buildToolLayout(
      title: _tr(L18nKeys.networkPortScan),
      ...
      topContent: Column(
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: _tr(L18nKeys.portRange),
              hintText: '80, 443',
              isDense: true,
            ),
          ),
