...
class DeDE {
  static const Map<String, String> translations = {
    ...
    L18nKeys.navNetworkTools: 'Netzwerk-Tools',
    L18nKeys.networkTools: 'Netzwerk-Tools',
    L18nKeys.networkPing: 'Ping-Test',
    L18nKeys.networkPerformanceTest: 'TCP/UDP Performance-Test',
    L18nKeys.networkSiteTest: 'Webseiten-Sicherheitscheck',
    L18nKeys.networkPortScan: 'Port-Scanner',
    L18nKeys.pingCount: 'Anzahl Pings',
    L18nKeys.pingInterval: 'Ping-Intervall (s)',
    L18nKeys.targetHost: 'Ziel-Host',
    L18nKeys.startTest: 'Test starten',
    L18nKeys.stopTest: 'Test stoppen',
    L18nKeys.scanPorts: 'Ports scannen',
    L18nKeys.portRange: 'Port-Bereich',
    L18nKeys.protocol: 'Protokoll',
    L18nKeys.connections: 'Verbindungen',
    L18nKeys.testMode: 'Testmodus',
    L18nKeys.modeClient: 'Client (Senden)',
    L18nKeys.modeServer: 'Server (Empfangen)',
    L18nKeys.intervalMs: 'Intervall (ms)',
    L18nKeys.dataSize: 'Datengröße',
    L18nKeys.socketSend: 'Socket Senden/s',
    L18nKeys.socketReceive: 'Socket Empfangen/s',
    L18nKeys.sendSpeed: 'Sendegeschwindigkeit',
    L18nKeys.receiveSpeed: 'Empfangsgeschwindigkeit',
  };
}
