...
class EnUS {
  static const Map<String, String> translations = {
    ...
    L18nKeys.navNetworkTools: 'Network Tools',
    L18nKeys.networkTools: 'Network Tools',
    L18nKeys.networkPing: 'Ping Test',
    L18nKeys.networkPerformanceTest: 'TCP/UDP Performance Test',
    L18nKeys.networkSiteTest: 'Site Security Test',
    L18nKeys.networkPortScan: 'Port Scanner',
    L18nKeys.pingCount: 'Ping Count',
    L18nKeys.pingInterval: 'Ping Interval (s)',
    L18nKeys.targetHost: 'Target Host',
    L18nKeys.startTest: 'Run Test',
    L18nKeys.startMonitor: 'Start Monitor',
    L18nKeys.startSend: 'Start Performance Test',
    L18nKeys.stopTest: 'Stop Test',
    L18nKeys.scanPorts: 'Scan Ports',
    L18nKeys.portRange: 'Port Range',
    L18nKeys.protocol: 'Protocol',
    L18nKeys.connections: 'Connections',
    L18nKeys.testMode: 'Test Mode',
    L18nKeys.modeClient: 'Client (Send)',
    L18nKeys.modeServer: 'Server (Receive)',
    L18nKeys.intervalMs: 'Interval (ms)',
    L18nKeys.dataSize: 'Data Size',
    L18nKeys.socketSend: 'Socket Send/s',
    L18nKeys.socketReceive: 'Socket Receive/s',
    L18nKeys.sendSpeed: 'Send Speed',
    L18nKeys.receiveSpeed: 'Receive Speed',
  };
}
