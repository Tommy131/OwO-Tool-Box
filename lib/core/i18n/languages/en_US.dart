...
class EnUS {
  static const Map<String, String> translations = {
    ...
    L18nKeys.welcomeMessage: 'A full-featured Flutter application framework',
    L18nKeys.welcomeDescription:
        'Multi-platform adaptive layout for mobile, tablet and desktop',
    L18nKeys.exploreFeatures: 'Explore Features',

    // ========== Theme Settings ==========
    L18nKeys.themeSettings: 'Theme Settings',
    L18nKeys.themeColorSettings: 'Theme Color',
    ...
    L18nKeys.defaultTheme: 'Default',
    L18nKeys.techTheme: 'Tech',
    L18nKeys.natureTheme: 'Nature',
    L18nKeys.sunsetTheme: 'Sunset',
    L18nKeys.oceanTheme: 'Ocean',

    // ========== Visual Effects ==========
    L18nKeys.visualEffects: 'Visual Effects',
    L18nKeys.visualEffectsDescription: 'Cyberpunk theme exclusive effects',
    ...
    L18nKeys.glowEffectDescription: 'Neon glow on head characters',
    L18nKeys.scanningLine: 'Scanning Line',
    L18nKeys.scanningLineDescription: 'Cyberpunk scan animation',
    ...
    L18nKeys.openSourceDescription:
        'This project is licensed under MIT. Contributions and suggestions are welcome.',
    L18nKeys.viewSourceCode: 'View Source Code',
    L18nKeys.license: 'License',
    L18nKeys.supportDevelopment: 'Support Development',
    L18nKeys.donationDescription: 'Your donation helps keep this project alive',
    ...
    L18nKeys.noDonorsYet: 'No donors yet',

    // ========== User Agreement ==========
    L18nKeys.userAgreement: 'User Agreement',
    L18nKeys.agreementContent:
        '1. This framework is for learning and development only\n2. Please comply with relevant laws and regulations\n3. Support mobile, tablet, PC platforms\n4. Developers reserve the right of final interpretation',
