...
class _DashboardPageState extends State<DashboardPage> {
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  _deviceData['platform'] ?? 'Unknown Platform',
          ...
          IconButton(
            ...
            tooltip: _tr(L18nKeys.refreshHostStatus),
          ),
        ],
      ),
    );
  ...
  Widget _buildStatsOverview(ThemeData theme, Color primaryColor) {
    ...
    if (_deviceData.containsKey('numberOfCores')) {
      stats.add({
        ...
        'label': _tr(L18nKeys.processor),
        'value': '${_deviceData['numberOfCores']} ${_tr(L18nKeys.coresUnit)}',
        'color': Colors.blue,
      });
    }
    ...
    if (_systemData.containsKey('totalPhysicalMemory')) {
      ...
      stats.add({
        ...
        'label': _tr(L18nKeys.memoryUsage),
        'value': '$usagePercent%',
        'color': Colors.green,
      });
      ...
      stats.add({
        'icon': Icons.storage_rounded,
        'label': _tr(L18nKeys.totalMemory),
        'value': '$totalGB GB',
        'color': Colors.green,
      });
    ...
    if (_systemData.containsKey('kernelArchitecture')) {
      stats.add({
        ...
        'label': _tr(L18nKeys.systemArchitecture),
    ...
    stats.add({
      ...
      'label': _tr(L18nKeys.platform),
      'value': _deviceData['platform'] ?? 'Unknown',
      'color': primaryColor,
    });
  ...
  Widget _buildSystemInfo(ThemeData theme, Color primaryColor) {
    ...
    if (Platform.isWindows) {
      ...
      if (_deviceData.containsKey('localizedModel')) {
        items.add({
          'label': _tr(L18nKeys.localizedModel),
    ...
    if (_systemData.containsKey('kernelVersion')) {
      items.add({
        'label': _tr(L18nKeys.kernelVersion),
        'value': _systemData['kernelVersion'],
      });
    }

    return InfoCard(
      title: _tr(L18nKeys.systemInfo),
  ...
  Widget _buildDeviceDetails(ThemeData theme, Color primaryColor) {
    ...
    return InfoCard(
      title: _tr(L18nKeys.deviceDetails),
  ...
  Widget _buildHardwareInfo(ThemeData theme, Color primaryColor) {
    ...
    if (_systemData.containsKey('motherboard')) {
      items.add({
        'label': _tr(L18nKeys.motherboard),
    ...
    if (_systemData.containsKey('processorModel')) {
      items.add({
        'label': _tr(L18nKeys.processorModel),
    ...
    if (_systemData.containsKey('kernelArchitecture')) {
      items.add({
        'label': _tr(L18nKeys.kernelArchitecture),
        'value': _systemData['kernelArchitecture'],
      });
    }

    return InfoCard(
      title: _tr(L18nKeys.hardwareDetails),
